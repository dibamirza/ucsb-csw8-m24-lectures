...
def play():
    ...
    new_lst = [int(elem) for elem in ["1", "2", "3", "4"]] # [1, 2, 3, 4]

    # In class activity: Challenge activity: 4.14.2: List comprehensions.
    # Next challenge! Your task in the breakout rooms is to correct the board initialization using list comprehension!!!
    ...
    while not gameover:
        print_board(board)
        move = input(f"Enter player {current_player}'s move (row, col): ") # "1, 2"
